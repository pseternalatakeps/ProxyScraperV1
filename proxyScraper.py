...
async def scrape(method, output, verbose):
    ...
    verbose_print(verbose, "\u001b[36m\u001b[1mScraping proxies\u001b[37m\u001b[1m...")
    proxies = []
    ...
    async def scrape_scraper(scraper):
        verbose_print(verbose, f"\u001b[37m\u001b[1mLooking \u001b[32m{scraper.get_url()}\u001b[37m\u001b[1m...")
    ...
    verbose_print(verbose, f"\u001b[1m\u001b[37mWriting \u001b[32m{len(proxies)} \u001b[1m\u001b[37mproxies to file...")
    with open(output, "w") as f:
        f.write("\n".join(proxies))
    verbose_print(verbose, "\u001b[1m\u001b[32mDone\u001b[37m!")
    verbose_print(verbose, f"\u001b[37m\u001b[1mTook \u001b[32m{time.time() - now} \u001b[37mseconds")
